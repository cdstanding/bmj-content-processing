...
2. Installation
 ...
 B. Run the setup from the jar file, using a Java VM of your choice.
    ...
    prompt:
      ...
      java -jar setup-4.25-2016-05-22.jar
    ...
    the command line:
      ...
      java -jar setup-4.25-2016-05-22.jar -c
...
RenderX (r), Copyright (c) 1999-2016 RenderX, Inc.  All rights reserved.
Patents issued.
