...
@echo off
set in-pub=\\bmjprod1\bmj\Editorial\_content_processing\xmlprocessing\bmj\proc_test\in_pub
set prodtracker=\\bmjprod1\bmj\Editorial\_content_processing\xmlprocessing\bmj\proc_test\prodtracker
