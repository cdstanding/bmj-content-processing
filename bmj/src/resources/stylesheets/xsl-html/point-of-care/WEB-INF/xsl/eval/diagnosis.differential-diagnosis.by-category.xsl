      ...
      <head>
        <title>
          <xsl:value-of select="$monographTitle" />
		          ...
		          - <xsl:call-template name="translate">
						<xsl:with-param name="messagekey">diagnosis.differential-diagnosis.by-category</xsl:with-param>
					</xsl:call-template>					
				 -
          ...
          <div class="differential-diagnosis">
            ...
            <div class="sort">
				<xsl:call-template name="translate-with-arguments">
					<xsl:with-param name="messagekey">body.diagnosis.differential-diagnosis.sort-by-category</xsl:with-param>
					<xsl:with-param name="arguments">
						<xsl:call-template name="basic-path" />
						<xsl:value-of select="'/diagnosis/differential-diagnosis.html'" />
					</xsl:with-param>
