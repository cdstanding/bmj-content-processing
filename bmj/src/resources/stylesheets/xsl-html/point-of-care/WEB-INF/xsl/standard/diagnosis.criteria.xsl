            ...
            <head>
              <title>
                <xsl:value-of select="$monographTitle" />
		          ...
		          - <xsl:call-template name="translate">
						<xsl:with-param name="messagekey">diagnosis.criteria</xsl:with-param>
					</xsl:call-template>					
				 -
	        ...
	        <body>
			    <div id="main-body">
					<div class="body-copy">
					   <h1>
						<xsl:call-template name="translate">
							<xsl:with-param name="messagekey">body.diagnosis.criteria.diagnostic-criteria</xsl:with-param>
						</xsl:call-template>
					   </h1>
					   <xsl:apply-templates/>
					</div><!-- /body copy -->
