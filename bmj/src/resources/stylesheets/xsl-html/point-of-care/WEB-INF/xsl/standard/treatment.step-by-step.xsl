	    ...
	    <html>
	        <head>
	            <title>
		          ...
		          - <xsl:call-template name="translate">
						<xsl:with-param name="messagekey">treatment.step-by-step</xsl:with-param>
					</xsl:call-template>	
				  -
	        ...
	        <body>
			    <div id="main-body">
					<div class="body-copy">
					    <h1>
				          	<xsl:call-template name="translate">
								<xsl:with-param name="messagekey">body.treatment.step-by-step.treatment-approach</xsl:with-param>
							</xsl:call-template>						    
					    </h1>
					    <xsl:apply-templates/>
					</div><!-- /body copy -->
