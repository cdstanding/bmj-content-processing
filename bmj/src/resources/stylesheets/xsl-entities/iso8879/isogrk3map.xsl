...
<!--
     File
  isogrk3map.xsl produced by the XSL script charmap.xsl
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
   <xsl:character-map name="isogrk3">
      ...
      <xsl:output-character character="Δ" string="&amp;Delta;"/>
      <xsl:output-character character="ϵ" string="&amp;epsi;"/>
      <xsl:output-character character="ϵ" string="&amp;epsis;"/>
      <xsl:output-character character="ε" string="&amp;epsiv;"/>
      ...
      <xsl:output-character character="ϕ" string="&amp;phis;"/>
      <xsl:output-character character="φ" string="&amp;phiv;"/>
      ...
      <xsl:output-character character="θ" string="&amp;thetas;"/>
