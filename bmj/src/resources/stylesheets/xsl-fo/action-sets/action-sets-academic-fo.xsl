...
<xsl:stylesheet 
	...
	<xsl:param name="image-action-set-background-600"/>
	            ...
	            <xsl:element name="fo:simple-page-master">
	               ...
	               <!-- Main Content page details-->
	                <xsl:element name="fo:region-body">
	                    ...
	                    <xsl:attribute name="background-image"><xsl:text>url('</xsl:text><xsl:value-of select="$image-action-set-background-600"/><xsl:text>')</xsl:text></xsl:attribute>
	                </xsl:element>
    ...
    <xsl:template name="header-contents">
        <fo:table table-layout="fixed" width="100%">
            ...
            <fo:table-body>
            	<xsl:attribute name="background-color">#C1DEF2</xsl:attribute>
                <fo:table-row>
                        ...
                        <fo:block>
                            <fo:table table-layout="fixed" width="100%">
                                ...
                                <fo:table-body>
                                    ...
                                    <xsl:call-template  name="three-column-10px-neutral-line"/>
                                </fo:table-body>
    ...
    <xsl:template name="footer-contents">
        <fo:table table-layout="fixed" width="100%">
            ...
            <fo:table-body>
                <xsl:call-template  name="three-column-15px-neutral-line"/>
    ...
    <!-- The highest level dark blue/grey header containing the document title -->
    <xsl:template match="action-set/caption">
        ...
        <fo:table-row>
            <fo:table-cell>
                ...
                <xsl:attribute name='background-color'>#45637B</xsl:attribute>
    ...
    <!-- The high level blue header bars with the white text-->
    <xsl:template match="category-list/category">
        
        <xsl:call-template  name="four-column-10px-neutral-line"/>
    ...
    <!-- The highest level content boxes, these appear below the grey/blue category/caption boxes -->
    <xsl:template match="category/component-list/component">
        ...
        <xsl:if 
            ...
            ">
            <xsl:call-template name="four-column-3px-neutral-line"/>
        </xsl:if>
   ...
   <!-- The lowest level main headings (in gray with black lettering)-->
    <xsl:template match="sub-category-list/sub-category">
        ...
        <fo:table-row>
            ...
            <fo:table-cell>
                ...
                <xsl:attribute name='background-color'>#ACD4ED</xsl:attribute>
    ...
    <!-- Creates a four column wide neutral line for seperating content 3px high-->
    <xsl:template name="four-column-3px-neutral-line">
    ...
    <!-- Creates a three column wide neutral line for seperating content 10px high-->
    <xsl:template name="three-column-10px-neutral-line">
    ...
    <!-- Creates a four column wide neutral line for seperating content 10px high-->
    <xsl:template name="four-column-10px-neutral-line">
    ...
    <!-- Creates a three column wide neutral line for seperating content 15px high-->
    <xsl:template name="three-column-15px-neutral-line">
