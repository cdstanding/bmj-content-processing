...
<xsl:stylesheet 
	...
	<xsl:include href="common-bh-fo-ar-sa.xsl"/>
				...
				<xsl:element name="fo:flow" use-attribute-sets="">
					...
					<xsl:element name="fo:block" use-attribute-sets="">
						...
						<xsl:element name="fo:external-graphic">
							...
							<!--<xsl:attribute name="src">C:/Documents and Settings/CPhipps/Desktop/BUG INFORMATION/Best Health Import-Export/Second Sprint 0011299/images/bmj_group.jpg</xsl:attribute> --> 									
						</xsl:element>	
						...
						<xsl:element name="fo:external-graphic">
							...
							<xsl:attribute name="content-width">20%</xsl:attribute>
							<xsl:attribute name="src"> 
								<xsl:text>url('</xsl:text><xsl:value-of select="$ksu-logo"/><xsl:text>')</xsl:text>
								</xsl:attribute>
							<!--<xsl:attribute name="src">C:/Documents and Settings/CPhipps/Desktop/BUG INFORMATION/Best Health Import-Export/Second Sprint 0011299/images/ksu_logo.jpg</xsl:attribute>	--> 								
						</xsl:element>	
						...
						<xsl:element name="fo:block" use-attribute-sets="">
							...
							<xsl:text>معلومات للمرضى من طرف مجموعة بي أم جي</xsl:text>
						</xsl:element>
					</xsl:element>
