...
<xsl:stylesheet 
		...
		<xsl:element name="fo:root" use-attribute-sets="">
			...
			<xsl:element name="fo:page-sequence" use-attribute-sets="">
				...
				<xsl:element name="fo:flow" use-attribute-sets="">
					...
					<xsl:apply-templates select="/article/body/survival-rates"/>
																				
					<xsl:element name="fo:block" use-attribute-sets="border space-before space-after"/>
	...
	<xsl:template match="article[@article-type='patient-treatment']">
		...
		<xsl:call-template name="treatment-section_list">
			<xsl:with-param name="id"><xsl:value-of select="@id"/></xsl:with-param>
		</xsl:call-template>
		<xsl:apply-templates select="body"/>
		<xsl:element name="fo:block" use-attribute-sets="border space-after"/>
	</xsl:template>
	...
	<xsl:template name="topic-section_list">
		<xsl:element name="fo:block" use-attribute-sets="space-after space-before">
			...
			<xsl:if test=".//body/survival-rates">
				<xsl:call-template name="add-topic-section">
					<xsl:with-param name="sectionName">survival-rates</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
		</xsl:element>
	</xsl:template>
