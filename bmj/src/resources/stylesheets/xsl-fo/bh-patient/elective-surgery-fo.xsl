...
<xsl:stylesheet 
	...
	<xsl:include href="common-bh-fo.xsl"/>
		...
		<xsl:element name="fo:root" use-attribute-sets="">
			...
			<xsl:element name="fo:page-sequence" use-attribute-sets="">
				...
				<xsl:element name="fo:flow" use-attribute-sets="">
					...
					<xsl:call-template name="section_list"/>
					...
					<xsl:element name="fo:block" use-attribute-sets="space-after">
						<xsl:apply-templates select="//article-glossaries"/>				
					</xsl:element>
	...
	<xsl:template name="section_list">
	...
	<xsl:template match="what-is-it | what-is-it-for | who-is-it-suitable-for | what-happens | treatment-choices | whats-the-outcome 
			|what-if-it-doesnt-work | what-are-the-risks | what-if-i-dont-have-it | what-are-the-alternatives | what-can-i-expect-afterwards">
