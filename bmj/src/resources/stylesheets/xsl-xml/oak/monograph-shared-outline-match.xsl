...
<xsl:stylesheet
    ...
    <xsl:template match="
        ...
        <xsl:choose>
            ...
            <xsl:when test="contains($components, 'tx-summary')">
                <xsl:call-template name="process-top-level-tx-summary"/>
            </xsl:when>
    ...
    <!--<xsl:template match="tx-options" mode="tx-summary">
    ...
    <xsl:template match="
        ...
        *:online-references
        "><!--figures | combined-references | article-references | online-references-->
    ...
    <!--<xsl:template match="tx-options[parent::treatment]" mode="tx-summary">
        
        <xsl:call-template name="process-level-2-section-with-heading-and-with-implied-grouping-summary"/>
    ...
    <xsl:template match="
        ...
        test[ancestor::diagnosis and ancestor::monograph-full] | 
        differential[ancestor::diagnosis and ancestor::monograph-full] | 
