...
<xsl:template match="mixed-citation/annotation">
  <fo:block>
...
<xsl:template match="mixed-citation/access-date | mixed-citation/article-title
                   | mixed-citation/collab | mixed-citation/comment
                   | mixed-citation/conf-date | mixed-citation/conf-loc
                   | mixed-citation/conf-name | mixed-citation/day
                   | mixed-citation/edition | mixed-citation/email
                   | mixed-citation/elocation-id| mixed-citation/fpage 
				   | mixed-citation/gov
                   | mixed-citation/issn | mixed-citation/isbn
                   | mixed-citation/issue | mixed-citation/lpage
                   | mixed-citation/month | mixed-citation/page-count | mixed-citation/patent
                   | mixed-citation/person-group | mixed-citation/pub-id
                   | mixed-citation/publisher-loc | mixed-citation/publisher-name
                   | mixed-citation/season | mixed-citation/series | mixed-citation/std
                   | mixed-citation/supplement | mixed-citation/time-stamp
                   | mixed-citation/trans-source | mixed-citation/trans-title
                   | mixed-citation/volume | mixed-citation/year">
  <xsl:apply-templates/>
</xsl:template>

<xsl:template match="etal">
<xsl:text>,&#x0020;etal</xsl:text>
<xsl:if test=".[following::text()[1][not(matches(.,'\.'))]]">
	<xsl:text>.</xsl:text>
</xsl:if>
<xsl:if test=".[following::text()[1][not(matches(.,'^ '))]]">
	<xsl:text>&#x0020;</xsl:text>
    ...
    <xsl:template match="name[position() &lt; last()][ancestor::mixed-citation]">
        <xsl:for-each select=".">
            <xsl:apply-templates/>
            <fo:inline>, </fo:inline>
        </xsl:for-each>
    ...
    <xsl:template match="name[last()][ancestor::mixed-citation]">
        <xsl:for-each select=".">
            <xsl:apply-templates/>
        </xsl:for-each>
    </xsl:template>
